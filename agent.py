...
class Agent:
    # 에이전트 상태가 구성하는 값 개수
    STATE_DIM = 2  # 주식 보유 비율, 포트폴리오 가치 비율  (Agent state Dimension)
    ...
    def __init__(
        ...
        self.max_trading_unit = max_trading_unit  # 최대 단일 거래 단위 : 결정한 행동 확신이 클때, 더많이 매수/매도
        ...
        self.base_portfolio_value = 0  # 직전 학습 시점의 PV : 현재PV와 비교 가치증가여부 판단
    ...
    # 매수/매도 수량 결정 : 경정행동의 확률이 높을수록 수량 크게
